...
import (
	...
	"github.com/butlerdotdev/butler-provider-aws/internal/controller"
	"github.com/butlerdotdev/butler-provider-aws/internal/imagesync"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "aws-provider.butlerlabs.dev",
	})
	if err != nil {
	...
	if err := (&controller.MachineRequestReconciler{
		...
		Recorder: mgr.GetEventRecorderFor("aws-provider"),
	...
	if err := (&controller.LoadBalancerRequestReconciler{
		Client:   mgr.GetClient(),
		Scheme:   mgr.GetScheme(),
		Recorder: mgr.GetEventRecorderFor("aws-provider"),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "LoadBalancerRequest")
		os.Exit(1)
	}
